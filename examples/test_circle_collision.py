...
# Bodies
engine.add_body(rigid.Body.Circle(x=-6, y=7.5, mass=1.0, radius=0.4, friction=0.5, restitution=0.1))
engine.add_body(rigid.Body.Circle(x=-5, y=6.0, mass=0.8, radius=0.3, friction=0.3, restitution=0.4))
engine.add_body(rigid.Body.Circle(x=-4, y=10.5, mass=0.5, radius=0.2, friction=0.5, restitution=1.5)) # bouncy boy :O
